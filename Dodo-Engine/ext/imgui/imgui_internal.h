...
struct ImDrawDataBuilder;           // Helper to build a ImDrawData vulkanInstance
...
struct ImGuiContext
{
    ...
    // Render
    ImDrawData              DrawData;                           // Main ImDrawData vulkanInstance to pass render information to the user
