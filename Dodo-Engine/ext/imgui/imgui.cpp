...
/*
 ...
 - 2018/02/07 (1.60) - reorganized context handling to be more explicit,
                       ...
                       - you may pass a ImFontAtlas* pointer to CreateContext() to share a font atlas between contexts. Otherwise CreateContext() will create its own font atlas vulkanInstance.
                       - removed allocator parameters from CreateContext(), they are now setup with SetAllocatorFunctions(), and shared by all contexts.
                       - removed the default global context and font atlas vulkanInstance, which were confusing for users of DLL reloading and users of multiple contexts.
 ...
 A: - Being highly portable (bindings for several languages, frameworks, programming style, obscure or older platforms/compilers),
    ...
    - If you are finding your UI traversal cost to be too large, make sure your string usage is not leading to excessive amount
      ...
      This is a small helper where you can vulkanInstance strings with configurable local buffers length. Many game engines will
 ...
 A: - You can create a dummy window. Call Begin() with the NoBackground | NoDecoration | NoSavedSettings | NoInputs flags.
    ...
    - You can create your own ImDrawList vulkanInstance. You'll need to initialize them ImGui::GetDrawListSharedData(), or create
...
// Note that we still point to some static data and members (such as GFontAtlas), so the state vulkanInstance you end up using will point to the static data within its module
