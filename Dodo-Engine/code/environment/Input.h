...
namespace Dodo
{
	namespace Environment
	{
		enum MouseKeyCode
		{
			KEY_MOUSE_BUTTON_1 = 0,
			KEY_MOUSE_BUTTON_2 = 1,
			KEY_MOUSE_BUTTON_3 = 2,
			KEY_MOUSE_BUTTON_4 = 3,
			KEY_MOUSE_BUTTON_5 = 4,
			KEY_MOUSE_BUTTON_6 = 5,
			KEY_MOUSE_BUTTON_7 = 6,
			KEY_MOUSE_BUTTON_8 = 7
		};
		enum KeyCode
		{
			KEY_UNKNOWN			   = -1,
		...
		{
		public:
			CInput(std::shared_ptr<CWindow> _window)
			{
				m_pWindow = _window;
